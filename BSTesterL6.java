...
public class BSTesterL6
{
	public static void main( String[] args ) throws Exception
	{
		...
		BSTreeL6<String> tree2 = tree1.makeBalancedCopyOf();
		...
		System.out.println( "tree2.equals(tree1)=" + tree1.equals(tree2) );
		levelCounts = tree2.calcLevelCounts();
		for (int i = 0 ; i<levelCounts.length; ++i )
			System.out.format("level:%2d   %d\n",i,levelCounts[i] );

		BSTreeL6<String> tree3 = new BSTreeL6<String>( tree2 );
		...
		System.out.println( "tree3.equals(tree2)=" + tree3.equals(tree2) );
